...
# Option 1: Place this at the entry point of your application (main.py, app.py, etc.)
# import dotenv
# dotenv.load_dotenv()

# Option 2: If you want to ensure .env is loaded for every module that imports this file,
# you can keep this here, but it's best practice to load .env only once at the very start.

# Option 3: For package-wide loading, create a dedicated config/bootstrap module:
# In scrai/engine/__init__.py or scrai/__init__.py, add:
# import dotenv; dotenv.load_dotenv()

# For this file (if you want to keep it here for local testing):
import dotenv
